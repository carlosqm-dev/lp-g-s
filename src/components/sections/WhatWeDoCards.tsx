      ...
      {services.map((service, index) => {
        ...
        return (
          <CardCurtainReveal
            ...
            className="h-[560px] cursor-pointer rounded-lg bg-primary text-background shadow-sm focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-accent md:h-[600px]"
          >
            ...
            <span
              aria-hidden="true"
              className={`pointer-events-none absolute inset-x-0 bottom-8 flex flex-col items-center gap-2 text-background/70 transition-opacity duration-300 ${
